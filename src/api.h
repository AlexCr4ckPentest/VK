...
public:
    ...
    bool auth(const std::string& login, const std::string& pass, const std::string& access_token = "");
    ...
    void set_fa2_callback(const callback_func_fa2 _fa2_callback = nullptr) noexcept
    { fa2_callback = _fa2_callback; }

    void set_cap_callback(const callback_func_cap cap_callback = nullptr) noexcept
    ...
    inline size_t user_id() const noexcept
    { return user.user_id; }

    inline std::string access_token() const
    { return a_t; }

    inline std::string last_error() const
    { return l_error; }
...
private:
    ...
    inline std::string get_captcha_key(const std::string& captcha_sid) const
    { return (captcha_callback != nullptr) ? captcha_callback(captcha_sid) : ""; }

    inline std::string get_fa2_code() const
